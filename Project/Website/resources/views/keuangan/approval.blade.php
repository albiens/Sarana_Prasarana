...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="approval"><em class="fa fa-check-square-o">&nbsp;</em> Approval</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container checkout">
			...
			<button type="button" class="btn btn-primary btn-lg btn-block checkbutton">
				<div class="row">
					<div class="col-md-4">SALMAN</div>
					<div class="col-md-4">20 OKTOBER 2019</div>
					<div class="col-md-4">PBJ-NK</div>
			</button>

			<button type="button" class="btn btn-primary btn-lg btn-block checkbutton">
				<div class="row">
					<div class="col-md-4">RUDI</div>
					<div class="col-md-4">17 AGUSTUS 2019</div>
					<div class="col-md-4">PBJ-K</div>
				</div>
			</button>

			<button type="button" class="btn btn-primary btn-lg btn-block checkbutton">
				<div class="row">
					<div class="col-md-4">REYHAN</div>
					<div class="col-md-4">15 JANUARY 2019</div>
					<div class="col-md-4">PBJ-NK</div>
				</div>
			</button>
			...
			<button type="button" class="btn btn-primary btn-lg btn-block checkbutton">
				<div class="row">
					<div class="col-md-4">NICKY</div>
					<div class="col-md-4">4 MEI 2019</div>
					<div class="col-md-4">PBJ-K</div>
				</div>
			</button>
			...
			<button type="button" class="btn btn-primary btn-lg btn-block checkbutton">
				<div class="row">
					<div class="col-md-4">RIAN TITIT</div>
					<div class="col-md-4">10 JULY 2019</div>
					<div class="col-md-4">PBJ-NK</div>
				</div>
			</button>
