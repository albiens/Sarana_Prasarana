...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="fpengajuan.html"><em class="fa fa-pencil">&nbsp;</em>Pengajuan</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			...
			<div class="row header-capt text-center">
				...
				<h3>SILAHKAN PILIH FORM YANG AKAN DIAJUKAN</h3>
			</div>
			...
			<div class="row pilihan">
					...
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><img src="/assets/img/pencil2.png">
							<div class="button-inven">
								<a class="btn btn-default" href="pbjnk" role="button">PBJ-NK</a>
							</div>
						</div>
					</div>
				</div>
				<div class="col-sm-2">
					<div class="panel panel-blue panel-widget ">
						<div class="row no-padding"><img src="/assets/img/pencil2.png">
							<div class="button-inven">
								<a class="btn btn-default" href="pbjk" role="button">PBJ-K</a>
							</div>
						</div>
					</div>
				</div>
