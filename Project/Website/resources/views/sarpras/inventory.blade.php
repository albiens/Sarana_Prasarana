...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li  class="active"><a href="inventory"><em class="fa fa-briefcase">&nbsp;</em> Inventory</a></li>
				      ...
				      <div class="modal-body col-sm-10 col-sm-offset-1">
				        <form>
						  	<div class="form-group">
						    	...
						    	<input type="text" class="form-control" id="nambar" placeholder="Masukkan Nama Barang">
						  	</div>
						  	<div class="form-group">
						  	  	<label for="Kode Barang">Kode Barang</label>
						    	<input type="text" class="form-control" id="kodbar" placeholder="Masukkan Kode Barang">
						  	</div>
						  	<div class="form-group">
						  	  	<label for="Min Stok">Min Stok</label>
						    	<input type="text" class="form-control" id="minstok" placeholder="Masukkan Stok Minimum">
						  	</div>
						  	<div class="form-group">
						  	  	<label for="Stok">Stok</label>
						    	<input type="text" class="form-control" id="stok" placeholder="Masukkan Jumlah Stok">
						  	</div>
						  	<div class="form-check col-sm-5 col-sm-offset-1">
