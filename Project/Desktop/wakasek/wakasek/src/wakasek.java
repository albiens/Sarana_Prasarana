 ...
 * @author RefinRian
 */
public class wakasek extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel17.setText("SELAMAT DATANG DI APLIKASI WAKIL KEPALA SEKOLAH");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(wakasek.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
